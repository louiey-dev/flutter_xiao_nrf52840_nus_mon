...
import 'package:flutter_xiao_nrf52840_nus_mon/screen/universal_ble_win/peripheral_details/widgets/services_list_widget.dart';
import 'package:flutter_xiao_nrf52840_nus_mon/screen/universal_ble_win/peripheral_details/widgets/services_side_widget.dart';
        ...
        return Scaffold(
          ...
          body: Row(
            ...
            children: [
              ...
              if (deviceType == DeviceType.desktop)
                Expanded(flex: 1, child: _buildResultWidget(scrollable: true)),
            ],
          ),
        );
      },
          ...
          onPressed: () async {
            if (isConnected) {
              ...
              await _executeWithLoading(
                ...
                onError: (error) {
                  _addLog('ConnectError (${error.runtimeType})', error);
                },
              );
            }
          },
          ...
          child: ExpansionTile(
            ...
            children: [
              ...
              if (bleDevice.manufacturerDataList.isNotEmpty) ...[
                ...
                Row(
                  children: [
                    Icon(Icons.memory, size: 18, color: colorScheme.secondary),
                    const SizedBox(width: 8),
                    Text(
                      'Manufacturer Data',
                      style: TextStyle(
              ...
              if (bleDevice.services.isNotEmpty) ...[
                ...
                Row(
                  children: [
                    Icon(Icons.list, size: 18, color: colorScheme.tertiary),
                    const SizedBox(width: 8),
                    Text(
                      'Advertised Services',
                      style: TextStyle(
      ...
      child: Card(
        ...
        child: Theme(
          ...
          child: ExpansionTile(
            ...
            leading: Icon(Icons.devices, color: colorScheme.primary, size: 24),
            title: Text(
              'Device Actions',
              style: TextStyle(
                fontWeight: FontWeight.bold,
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    if (discoveredServices.isNotEmpty)
                      OutlinedButton.icon(
                        onPressed: () async {
                          final servicesText = discoveredServices
                              .map((s) => s.uuid)
                              .join('\n');
    ...
    return ServicesListWidget(
      ...
      onTap: (service, characteristic) {
        setState(() {
          ...
          PeripheralDetailPage.globalSelectedCharacteristic = characteristic;
        });
        onSelect?.call(service, characteristic);
      },
      onFavoriteToggle: (serviceUuid) {
        setState(() {
          if (_favoriteServices.contains(serviceUuid)) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            Clipboard.setData(
                              ClipboardData(text: selectedService?.uuid ?? ""),
                            );
                            _showSnackBar('Copied to clipboard');
                          },
                          child: Text(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Wrap(
                          spacing: 4,
                          runSpacing: 4,
                          children: selectedCharacteristic!.properties.map((
                            prop,
                          ) {
                            return Container(
                              padding: const EdgeInsets.symmetric(
