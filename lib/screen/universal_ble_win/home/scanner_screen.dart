...
import 'package:flutter_xiao_nrf52840_nus_mon/screen/universal_ble_win/data/mock_universal_ble.dart';
import 'package:flutter_xiao_nrf52840_nus_mon/screen/universal_ble_win/home/widgets/ble_availability_icon.dart';
import 'package:flutter_xiao_nrf52840_nus_mon/screen/universal_ble_win/home/widgets/drawer.dart';
import 'package:flutter_xiao_nrf52840_nus_mon/screen/universal_ble_win/home/widgets/queue_selector_widget.dart';
import 'package:flutter_xiao_nrf52840_nus_mon/screen/universal_ble_win/home/widgets/scan_filter_widget.dart';
import 'package:flutter_xiao_nrf52840_nus_mon/screen/universal_ble_win/home/widgets/scanned_devices_placeholder_widget.dart';
import 'package:flutter_xiao_nrf52840_nus_mon/screen/universal_ble_win/home/widgets/scanned_item_widget.dart';
...
class _ScannerScreenState extends State<ScannerScreen> {
  ...
  Future<void> _startScan() async {
    ...
    try {
      ...
      if (scanFilter != null || platformConfig != null) {
  ...
  Widget build(BuildContext context) {
    ...
    if (_selectedDevice != null) {
      return PopScope(
        ...
        child: PeripheralDetailPage(_selectedDevice!),
      );
    }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: Icon(Icons.queue, color: colorScheme.onSurface),
            tooltip: 'Queue Type',
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.web, size: 18, color: colorScheme.primary),
