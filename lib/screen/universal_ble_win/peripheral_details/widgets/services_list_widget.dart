...
import 'package:flutter_xiao_nrf52840_nus_mon/screen/universal_ble_win/data/utils.dart';
...
class ServicesListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedCharacteristicBackgroundColor = colorScheme.primaryContainer
